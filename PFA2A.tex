...
QGIS est principalement conçu pour fonctionner avec des données vectorielles SIG, il prend en charge de nombreux formats d'images raster via la bibliothèque open source GDAL et GRASS.\\

Enfin, il existe de nombreux codes spécifiques au format pour plusieurs langages (Python, C, Java, etc.) qui vous permettront de lire vos données et d'appliquer les transformations dont vous avez besoin. Bien sûr, ce n'est pas une approche "pointer et cliquer".\\
