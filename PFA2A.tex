...
\\\texttt{http://www.agriculturebiodiversite.fr/ameliorer-la-biodiversite\\/amenager-son-exploitation/fragmentation-du-parcellaire.html}

\bibitem{imagesatt}
Les images et les statistiques concernat le Maroc\\
\textit{Centre Royal de Télédétection Spatiale}.
\\\texttt{https://www.crts.gov.ma/thematiques/agriculture}

\bibitem{orbite}
Combien de satellite tournent autour de la Terre ?
\textit{Céline Deluzarche, Publié le 12/04/2020, FUTURA SCIENCES}
\\\texttt{https://www.futura-sciences.com/sciences/questions-reponses/satellite\\-satellites-tournent-autour-terre-7065/}

\bibitem{satt} 
Les satellites au service de l'agriculture\\
\textit{Article de Rémy Decourt publié le 4 avril 2011}.
\\\texttt{https://www.futura-sciences.com/sciences/actualites/astronautique-s\\atellites-service-agriculture-29034/}

\bibitem{cropmapp}
Generating Crop Classification Maps Using AI\\
\textit{David Markowitz, 6 May 2019, Planet Watchers}
\\\texttt{https://www.planetwatchers.com/generating-crop-classification-maps-\\using-ai}

\bibitem{modis}
La méthode MODIS\\
\textit{Kamel Didan, Moderate Resolution Imaging Spectroradiometer, NASA}
\\\texttt{https://modis.gsfc.nasa.gov/data/dataprod/mod13.php}

\bibitem{deeplearning}
Deep Learning Classification\\
\textit{ IEEE Geoscience and Remote Sensing Letters ( Volume: 14 , Issue: 5 , May 2017 )}
\\\texttt{https://ieeexplore.ieee.org/abstract/document/7891032?fbclid=IwAR3T\\iBL273ykf0RpPCORrCK0hayB4ePCgp21eh76O0cBOBMBszCdKtk2E1g}
