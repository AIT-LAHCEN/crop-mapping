...
\caption{L'agro-industrie au maroc}
\end{figure}
...
\hline
\diagbox{caractéristiques}{L'outil}&ENVI&QGIS&ArcGIS&CMaps&TerrSet&Groundwork\\
\hline
Imagerie 3D & - & + & + & - & - & -\\
\hline
...
\subsubsection{Pour les algorithmes :}
...
Enfin, il existe de nombreux codes spécifiques au format pour plusieurs langages (Python, C, Java, etc.) qui vous permettront de lire vos données et d'appliquer les transformations dont vous avez besoin.\\
...
Cette outil qui est gratuit permet la création d'une "training data set" d'image géospatiale en implémentant une machine learning.\cite{groundwork}
\par
